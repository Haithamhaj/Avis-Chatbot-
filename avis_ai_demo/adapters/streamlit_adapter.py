...
WELCOME_MESSAGE = (
    "مرحبًا بك في أفيس السعودية. معك خالد، المساعد الذكي من أفيس. "
    "أقدر أساعدك في حجز سيارة، معرفة الأسعار اليومية أو الشهرية، الفروع وساعات العمل، "
    "شروط التأجير والوديعة، أو طلب مساعدة على الطريق. كيف أقدر أساعدك؟"
)
